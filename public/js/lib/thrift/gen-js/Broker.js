...
import {Location, Node, Iteration, IterationBundle, Init, NoDataException} from "./visualizer_types.js";
...
const Broker_publishIterations_args = function(args) {
  this.itDataList = null;
  if (args) {
    if (args.itDataList !== undefined && args.itDataList !== null) {
      this.itDataList = Thrift.copyList(args.itDataList, [Iteration]);
    } else {
...
const Broker_publishIterations_result = function(args) {
};
...
BrokerClient.prototype.publishIterations = function(itDataList, callback) {
  this.send_publishIterations(itDataList, callback); 
};

BrokerClient.prototype.send_publishIterations = function(itDataList, callback) {
  this.output.writeMessageBegin('publishIterations', Thrift.MessageType.ONEWAY, this.seqid);
  var params = {
