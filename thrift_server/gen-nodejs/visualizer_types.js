...
var Iteration = module.exports.Iteration = function(args) {
  ...
  if (args) {
    ...
    if (args.addToProjectedPath !== undefined && args.addToProjectedPath !== null) {
      this.addToProjectedPath = Thrift.copyList(args.addToProjectedPath, [ttypes.Location]);
    }
    if (args.removeFromProjectedPath !== undefined && args.removeFromProjectedPath !== null) {
      this.removeFromProjectedPath = Thrift.copyList(args.removeFromProjectedPath, [ttypes.Location]);
    }
  }
};
Iteration.prototype = {};
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.BOOL) {
        this.clearPreviousEnvelope = input.readBool();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 4:
      if (ftype == Thrift.Type.BOOL) {
        this.clearPreviousBackup = input.readBool();
      } else {
        input.skip(ftype);
      }
      break;
